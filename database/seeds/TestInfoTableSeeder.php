    ...
    public function run()
    {
        DB::table('test_informations')->insert([
            [
                ...
                'professional_help' => '',
                'url_interest' => 'http://www.cooperativa.cl/noticias/sociedad/salud/sepa-como-aplicar-bien-el-consumo-controlado-de-alcohol/2012-09-15/182305.html',
                'min' => '0',
                'max' => '7',
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'http://www.narconon.org/es/consumo-de-drogas/abuso-de-alcohol-signos.html',
                'min' => '8',
                'max' => '19',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                ',
                'url_interest' => 'https://medlineplus.gov/spanish/ency/article/000944.htm',
                'min' => '20',
                'max' => '40',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'https://www.drugabuse.gov/es/informacion-sobre-drogas',
                'min' => '0',
                'max' => '3',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'https://www.drugabuse.gov/es/publicaciones/juventud-latina/los-riesgos-del-abuso-de-drogas',
                'min' => '4',
                'max' => '26',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'http://www.clinicanovo.es/jovenes-tabaco-riesgos-y-consecuencias/',
                'min' => '0',
                'max' => '3',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'http://habitosysalud.com/tabaco-y-enfermedades-asociadas/',
                'min' => '4',
                'max' => '26',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'http://www.neumologica.org/exfumaireLanding/?utm_source=SEM&utm_medium=cpc&utm_term=Antitabaquismo-clics-Awareness-CO&utm_content=Antitabaquismo-Consecuencias&utm_campaign=Pfizer_Category_Antitabaquismo',
                'min' => '27',
                'max' => '50',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'https://www.drugabuse.gov/es/publicaciones/serie-de-reportes/abuso-de-inhalantes/que-son-los-inhalantes',
                'min' => '0',
                'max' => '3',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'http://adiccionyciencia.info/uso-de-inhalantes-y-riesgos-del-consumo-en-adolescentes',
                'min' => '4',
                'max' => '26',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'https://www.psyciencia.com/ludopatia-caracteristicas-y-tratamiento/',
                'min' => '0',
                'max' => '4',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'http://www.webconsultas.com/mente-y-emociones/adicciones/como-saber-si-se-es-ludopata',
                'min' => '5',
                'max' => '11',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                ',
                'url_interest' => 'http://www.sindrome-adicciones.es/7-consecuencias-de-la-ludopatia/',
                'min' => '12',
                'max' => '20',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'http://www.unilibre.edu.co/bogota/ul/noticias/noticias-universitarias/2349-redes-sociales-el-us-y-el-abuso',
                'min' => '0',
                'max' => '24',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'http://www.grupodoctoroliveros.com/adiccion-al-whatsapp',
                'min' => '25',
                'max' => '60',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'http://www.comie.org.mx/congreso/memoriaelectronica/v11/docs/area_07/0295.pdf',
                'min' => '61',
                'max' => '96',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'url_video' => 'wJRwUHPJnpA',
                'professional_help' => '',
                'url_interest' => 'https://www.sura.com/blogs/calidad-de-vida/riesgos-tecnologia-salud.aspx',
                'min' => '0',
                'max' => '49',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'url_video' => 'XC-z8cfVNSg',
                'professional_help' => '',
                'url_interest' => 'https://www.infobae.com/2015/02/16/1626651-como-reconocer-un-adicto-la-tecnologia/',
                'min' => '50',
                'max' => '79',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'url_video' => 'sFn1e5clvDI',
                'professional_help' => '',
                'url_interest' => 'http://www.webconsultas.com/mente-y-emociones/adicciones/adiccion-a-internet-sintomas-y-soluciones',
                'min' => '80',
                'max' => '100',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'https://mejorconsalud.com/5-riesgos-de-la-dependencia-emocional-en-pareja/',
                'min' => '0',
                'max' => '46',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'http://www.el-nacional.com/noticias/historico/conozca-los-riesgos-dependencia-emocional_45049',
                'min' => '47',
                'max' => '92',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'https://www.psicologiamadrid.es/blog/articulos/problemas-psicologicos/la-dependencia-emocional-conoce-sus-caracteristicas-y-consecuencias',
                'min' => '93',
                'max' => '183',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'url_video' => 'tsJMXzCmfw4',
                'professional_help' => '',
                'url_interest' => 'https://www.ecured.cu/Sexualidad_sana',
                'min' => '0',
                'max' => '2',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'url_video' => 'TX_ioW_hx4w',
                'professional_help' => '',
                'url_interest' => 'http://www.bbc.com/mundo/noticias/2014/07/140714_salud_cerebro_adictos_sexo_ar',
                'min' => '2',
                'max' => '6',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                <h3>Teléfono: 422 55 25</h3>
                Sitio web: <a href="http://www.centrocita.org/"><strong>www.centrocita.org</strong></a>',
                'url_interest' => 'http://www.europapress.es/sociedad/noticia-pareja-adicta-sexo-hago-20160915140516.html',
                'min' => '7',
                'max' => '12',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'url_video' => 'tsJMXzCmfw4',
                'professional_help' => '',
                'url_interest' => 'https://polis.revues.org/2687',
                'min' => '0',
                'max' => '4',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'url_video' => 'TX_ioW_hx4w',
                'professional_help' => '',
                'url_interest' => 'https://psicologiaymente.net/clinica/workaholic-adiccion-al-trabajo',
                'min' => '5',
                'max' => '8',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                <h3>Teléfono: 422 55 25</h3>
                Sitio web: <a href="http://www.centrocita.org/"><strong>www.centrocita.org</strong></a>',
                'url_interest' => 'http://www.webconsultas.com/mente-y-emociones/trabajo-y-tiempo-libre/como-prevenir-y-tratar-la-adiccion-al-trabajo',
                'min' => '9',
                'max' => '12',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'url_video' => 'tsJMXzCmfw4',
                'professional_help' => '',
                'url_interest' => 'http://www.codigonuevo.com/los-rasgos-psicologicos-de-un-comprador-compulsivo/',
                'min' => '0',
                'max' => '1',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'url_video' => 'TX_ioW_hx4w',
                'professional_help' => '',
                'url_interest' => 'https://www.psicoactiva.com/blog/la-compra-compulsiva-quien-la-padece-y-por-que/',
                'min' => '2',
                'max' => '3',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'url_video' => 'M6vY8so1dE8',
                'professional_help' => '',
                'url_interest' => 'https://www.adiccion.co/adiccion-a-las-compras.html',
                'min' => '4',
                'max' => '5',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'https://clinicadeansiedad.com/problemas/introduccion/ansiedad-y-personalidad/',
                'min' => '0',
                'max' => '45',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'https://www.nimh.nih.gov/health/publications/espanol/trastorno-de-ansiedad-generalizada-cuando-no-se-pueden-controlar-las-preocupaciones-new/index.shtml',
                'min' => '46',
                'max' => '100',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'http://www.depresion.psicomag.com/sinto_depre.php',
                'min' => '0',
                'max' => '45',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'https://www.nimh.nih.gov/health/publications/espanol/depresion/index.shtml',
                'min' => '46',
                'max' => '100',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'https://www.drugabuse.gov/es/publicaciones/como-prevenir-el-uso-de-drogas/capitulo-1-los-factores-de-riesgo-y-los-factores-de-proteccion/cuales-son-los-fa',
                'min' => '0',
                'max' => '32',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'https://www.banmedica.cl/efectos-riesgos-del-consumo-drogas/',
                'min' => '33',
                'max' => '64',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'professional_help' => '',
                'url_interest' => 'http://www.iofc.org/es/abt/ideas/cp',
                'min' => '0',
                'max' => '40',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'url_video' => 'KxXPUvhyFvU',
                'professional_help' => '',
                'url_interest' => 'https://psicologiaymente.net/psicologia/modelo-transteorico-cambio-prochaska-diclemente',
                'min' => '41',
                'max' => '80',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'url_video' => 'KxXPUvhyFvU',
                'professional_help' => '',
                'url_interest' => 'https://www.psyciencia.com/el-modelo-de-prochaska-y-diclemente-un-modelo-de-cambio/',
                'min' => '81',
                'max' => '120',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'url_video' => 'B_QInKl4XZQ',
                'professional_help' => '',
                'url_interest' => 'http://lacodependencia.org/algunas-caracteristicas-de-la-codependencia/',
                'min' => '0',
                'max' => '43',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'url_video' => 'GXirLXrW9Lc',
                'professional_help' => '',
                'url_interest' => 'http://www.webconsultas.com/mente-y-emociones/familia-y-pareja/consecuencias-de-la-codependencia',
                'min' => '44',
                'max' => '86',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'url_video' => 'U0ze7gLmQj4',
                'professional_help' => '',
                'url_interest' => 'http://www.adicciones.org/familia/codependencia.html',
                'min' => '87',
                'max' => '130',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
